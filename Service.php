...
namespace Box\Mod\Servicecolocation;
...
class Service
{
    ...
    {
        $sql = '
        CREATE TABLE `service_colocation` (
    ...
    {
        $this->di['db']->exec('DROP TABLE IF EXISTS `service_colocation`');
    }
    ...
    public function create($order)
    {
        ...
        $model = $this->di['db']->dispense('service_colocation');
